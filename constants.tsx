...
export const brands: Brand[] = [
    { id: 1, name: 'Optimum Nutrition', logo: 'https://cdn.hpm.io/wp-content/uploads/2019/06/25133501/ON_logo_black.png', isFeatured: true },
    { id: 2, name: 'Myprotein', logo: 'https://static.thcdn.com/www/common/images/logos/logo-myprotein.svg', isFeatured: true },
    { id: 3, name: 'Rule 1', logo: 'https://cdn.shopify.com/s/files/1/0572/6533/3218/files/Rule1-Logo-Final-2021-01.png?v=1631589139', isFeatured: true },
    { id: 4, name: 'Applied Nutrition', logo: 'https://appliednutrition.uk/cdn/shop/files/Applied_Nutrition_Logo-01_1200x.png?v=1614285899', isFeatured: true },
    { id: 5, name: 'Nutrabolt (C4)', logo: 'https://seeklogo.com/images/C/c4-energy-logo-116223591A-seeklogo.com.png', isFeatured: true },
    { id: 6, name: 'BPI Sports', logo: 'https://cdn.shopify.com/s/files/1/0568/5074/3339/files/BPI_Sports_Logo.png?v=1635338148', isFeatured: true },

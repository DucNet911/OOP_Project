...
const OrderHistoryPage: React.FC<OrderHistoryPageProps> = ({ onGoHome, orders, onCancelOrder }) => {
  return (
    <div className="container mx-auto px-4 py-12">
      <Breadcrumbs items={[{ label: 'Trang chủ', onClick: onGoHome }, { label: 'Lịch sử đơn hàng' }]} />

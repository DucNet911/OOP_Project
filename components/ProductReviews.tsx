...
const ProductReviews: React.FC<ProductReviewsProps> = ({ reviews, averageRating, totalReviews, currentUser, onSubmitReview, onAuthClick }) => {
        ...
        <section className="bg-gym-dark p-8 rounded-lg">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
                ...
                <div className="md:col-span-2 space-y-2">
                    <RatingBar rating={5} count={ratingCounts[5]} total={totalReviews} />
                    <RatingBar rating={4} count={ratingCounts[4]} total={totalReviews} />
                    <RatingBar rating={3} count={ratingCounts[3]} total={totalReviews} />
                    <RatingBar rating={2} count={ratingCounts[2]} total={totalReviews} />
                    <RatingBar rating={1} count={ratingCounts[1]} total={totalReviews} />
                </div>
            </div>

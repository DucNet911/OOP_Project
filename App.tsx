...
import { Product, Theme, User, Order, OrderStatus, CartItem, Review, Article } from './types';
...
import { navLinks, allProducts as initialProducts, supplementArticles as initialSupplementArticles, nutritionArticles as initialNutritionArticles } from './constants';
